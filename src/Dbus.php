...
/**
 * Stub file for code completion.
 *
 * @see https://github.com/nephre/skypebot/blob/master/src/Skypebot/Dbus.php
 */
namespace Druplicon;
 ...
 * @method mixed      __call(\string $name, array $arguments = null) Magic method
